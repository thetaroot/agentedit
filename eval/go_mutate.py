"""AST-based Go mutations for the eval benchmark (mirrors ts/py mutators)."""
from __future__ import annotations

from collections.abc import Iterator
from typing import Any

from agentedit.backends.go import parse_tree

_DECL_TYPES = frozenset({"function_declaration", "method_declaration", "type_declaration"})
...
def mutate(path: str, source: bytes, name: str, start_row: int, mutation: str) -> str | None:
    ...
    if mutation == "add-required-param":
        ...
        if params.end_byte > params.start_byte and text[params.end_byte - 1] == ")":
            ...
            return _apply(text, [(insert_at, insert_at, addition + "_req string")])
        return None
