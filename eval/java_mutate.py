"""AST-based Java mutations for the eval benchmark (mirrors other mutators)."""
from __future__ import annotations

from collections.abc import Iterator
from typing import Any

from agentedit.backends.java import parse_tree
...
def mutate(path: str, source: bytes, name: str, start_row: int, mutation: str) -> str | None:
    ...
    if mutation == "add-required-param":
        ...
        if params.end_byte > params.start_byte and text[params.end_byte - 1] == ")":
            ...
            return _apply(text, [(insert_at, insert_at, addition + "int agenteditReq")])
        return None
